...
class CalibWidget(QWidget):
    ...
    def __init__(self):
        ...
        ui_file = os.path.join(rospkg.RosPack().get_path(
            'dvs_calibration_gui'), 'resource', 'widget.ui')
        loadUi(ui_file, self)
        ...
        self._sub_pattern_detections = rospy.Subscriber(
            'dvs_calibration/pattern_detections', Int32, self.pattern_detections_cb)
    ...
    def on_button_start_calibration_pressed(self):
        ...
        try:
            ...
            try:
                start_calibration_service = rospy.ServiceProxy(
                    'dvs_calibration/start', Empty)
    ...
    def on_button_save_calibration_pressed(self):
        try:
            ...
            try:
                save_calibration_service = rospy.ServiceProxy(
                    'dvs_calibration/save', Empty)
